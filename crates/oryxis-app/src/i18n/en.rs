...
pub(super) fn lookup(key: &str) -> &'static str {
    match key {
        ...
        "net_hint_ping" => "Sends four echo requests through the system ping and reports loss and round-trip time.",
        "net_hint_traceroute" => "Walks the path to the host one hop at a time, through the system traceroute.",
